...
export default function SearchButton() {
  ...
  return (
    <div className="absolute inset-y-0 right-0 flex flex-row items-center max-xs:pr-3 pr-4">
      <button
        type="button"
      ...
      >
        ...
        <SearchIcon className="max-xs:size-5.5 size-6 stroke-zinc-900 dark:stroke-white" />
      </button>
